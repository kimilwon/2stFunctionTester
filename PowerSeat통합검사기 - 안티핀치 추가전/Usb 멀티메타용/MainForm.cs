    ...
    public partial class MainForm : Form, MyInterface
    {
        ...
        */
                            ...
                            if (PassButtonCheckFlag == false)
                            {
                                if (RunningFlag == false)
                                {
                                    ...
                                    if (led4.Value.AsBoolean == true)//제품이 있을 경우
                                    {
                                        ...
                                        else if ((label16.Text != "불량") && (xFlag == false))
                                        {
        ...
        private void DisplaySpec()
        {
            ...
            fpSpread1.ActiveSheet.Cells[12, 3].Text = string.Format("{0:0.0}[Ω] 이상", TSpec.SBR.NotLoad);
            fpSpread1.ActiveSheet.Cells[13, 3].Text = string.Format("{0:0.0}[Ω] 이상", TSpec.SBR.Load15Kg);
            fpSpread1.ActiveSheet.Cells[14, 3].Text = string.Format("{0:0.0}[Ω] 미만", TSpec.SBR.Load30Kg);
            return;
        }
