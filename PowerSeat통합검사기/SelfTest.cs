        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            try
            {
                ...
                //if (switchLever2.Value.AsBoolean == true)
                {
                    ...
                    {
                        if (999999 < mControl.GetMultiMeter.GetData)
                            fpSpread1.ActiveSheet.Cells[36, 5].Text = "HHHH";
                        else fpSpread1.ActiveSheet.Cells[36, 5].Text = string.Format("{0:0.00}", mControl.GetMultiMeter.GetData);
                    }
                    for (int i = 0; i < 24; i++)
                    {
                        Data = (ulong)(0x01 << i);
                ...
                if (mControl.GetIOPort.Get1StUpSensor == true)
                {
                    ...
                    //}
                    if (mControl.GetIOPort.GetRightSelect == true)
                    {
                        //if (IOLeftSelect == false)
                        //{
                        //    IOLeftSelect = true;
                    ...
                    if (mControl.GetIOPort.GetBwdSelect == true)
                    {
                        //if (IOFwdSelect == false)
                        //{
                        //    IOFwdSelect = true;
                ...
                if (mControl.GetIOPort.Get1StUpSelect == true)
                {
                    //if (IO1StDownSelect == false)
                    //{
                    //    IO1StDownSelect = true;
                ...
                //if (mControl.GetIOPort.Get1StDnSensor == true)
                {
                    ...
                    if (mControl.GetIOPort.Get2StUpSelect == true)
                    {
                        //if (IO2StDownSelect == false)
                        //{
                        //    IO2StDownSelect = true;
...
//        }
        ...
        private void switchLever2_ValueChanged(object sender, Iocomp.Classes.ValueBooleanEventArgs e)
        {
            if (e.ValueNew == true)
                mControl.GetCanReWrite.LhRhSelect = LHRH.RH;
            else mControl.GetCanReWrite.LhRhSelect = LHRH.LH;
            return;
        }
    }
}
