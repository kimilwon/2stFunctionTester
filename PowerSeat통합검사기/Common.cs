...
//        private IntPtr hWnd;
    ...
    public class ConfigSetting
    {
        ...
        private void OpenConfig()
        {
            ...
            xConfig.MultiMeter.Port = Settings.Default.MULTIMETER_PORT;
            xConfig.MultiMeter.Speed = Settings.Default.MULTIMETER_SPEED;
            return;
        }
        ...
        private void SaveConfig()
        {
            ...
            Settings.Default.IO_CARD_SPEED = xConfig.SerialtypeIOCard.Speed;

            Settings.Default.MULTIMETER_PORT = xConfig.MultiMeter.Port;
            Settings.Default.MULTIMETER_SPEED = xConfig.MultiMeter.Speed;
