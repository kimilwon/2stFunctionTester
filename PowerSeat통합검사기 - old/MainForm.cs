...
namespace PowerSeat통합검사기
{
    public interface MyInterface
    {
        ...
        MultiMeterControl GetMultiMeter { get; }
    ...
    public partial class MainForm : Form, MyInterface
    {
        ...
        private MultiMeterControl MultiMeter;
        ...
        */
        ...
        private MES_Control.__ReadMesData__ PopData;
                ...
                if (ExitFlag == false)
                {
                    ...
                    if ((DialogFlag == false) && (SelfTestMode == false))
                    {
                            ...
                            if (PassButtonCheckFlag == false)
                            {
                                if (RunningFlag == false)
                                {
                                    ...
                                    if (IOPort.GetAuto == true)
                                    {
                                        ...
                                        {
                                            PopDataReadFlag = OldPopDataReadFlag;  
                                        }
                                    }
                                    else
                                    {
                        ...
                        if (IOPort.GetAuto == true)
                        {
                            ...
                            if(led2.Indicator.Text != "AUTO") led2.Indicator.Text = "AUTO";
                        ...
                        else
                        {
                            ...
                            if (led2.Indicator.Text != "MANNUAL") led2.Indicator.Text = "MANNUAL";
                            ...
                            if (SelfTestMode == false)
                            {
                                ...
                                if (imageButton9.ButtonColor == Color.Red)
                                {
                                    if (IOPort.Get1StUpSensor == true)
                                    {
                                        ...
                                        if (IOPort.GetRightSelect == true) //if (IOLeftSelect == true)
                                        {
                                            IOLeftSelect = false;
        ...
        private bool SerialOpen()
        {
            ...
            try
            {
                ...
                MultiMeter = new MultiMeterControl();
                MultiMeter.Open();
        ...
        private void DisplaySpec()
        {
            ...
            if ((CheckItem.Heater.Curr == true) && (CheckItem.Vent.Curr == false))
                fpSpread1.ActiveSheet.Cells[2, 3].Text = string.Format("{0:0.00} ~ {1:0.00}[A]", TSpec.Heater.Min, TSpec.Heater.Max);
            else fpSpread1.ActiveSheet.Cells[2, 3].Text = string.Format("{0:0.00} ~ {1:0.00}[A]", TSpec.VentHeater.Min, TSpec.VentHeater.Max);
            
            fpSpread1.ActiveSheet.Cells[4, 3].Text = string.Format("{0:0.0} ~ {1:0.0}[A]", TSpec.Vent.Min, TSpec.Vent.Max);
                        
            fpSpread1.ActiveSheet.Cells[7, 3].Text = string.Format("{0:0.0} ~ {1:0.0}[Ω]", TSpec.Retractor.Min, TSpec.Retractor.Max);
            //fpSpread1.ActiveSheet.Cells[11, 3].Text = string.Format("{0:0.0} ~ {1:0.00}[Ω]", TSpec.SBR.Min, TSpec.SBR.Max);

            fpSpread1.ActiveSheet.Cells[8, 3].Text = string.Format("{0:0.0} ~ {1:0.0}[A]", TSpec.PWSwitch.Min, TSpec.PWSwitch.Max);
            fpSpread1.ActiveSheet.Cells[9, 3].Text = string.Format("{0:0.0} ~ {1:0.0}[A]", TSpec.PWSwitch.Min, TSpec.PWSwitch.Max);
            fpSpread1.ActiveSheet.Cells[10, 3].Text = string.Format("{0:0.0} ~ {1:0.0}[A]", TSpec.PWSwitch.Min, TSpec.PWSwitch.Max);
            fpSpread1.ActiveSheet.Cells[11, 3].Text = string.Format("{0:0.0} ~ {1:0.0}[A]", TSpec.PWSwitch.Min, TSpec.PWSwitch.Max);

            fpSpread1.ActiveSheet.Cells[12, 3].Text = string.Format("{0:0}[Ω] 이상", TSpec.SBR.NotLoad);
            fpSpread1.ActiveSheet.Cells[13, 3].Text = string.Format("{0:0}[Ω] 이상", TSpec.SBR.Load15Kg);
            fpSpread1.ActiveSheet.Cells[14, 3].Text = string.Format("{0:0}[Ω] 미만", TSpec.SBR.Load30Kg);
            return;
        }
...
//#if !POP_MODE
            ...
            if ((CheckItem.Lin == false) && (CheckItem.SWVent == true)) CheckItem.Lin = true;
            if ((CheckItem.CanCheck == true) && (comboBox5.SelectedItem.ToString() != "CAN")) comboBox5.SelectedItem = "CAN";
            else if ((CheckItem.CanCheck == false) && (comboBox5.SelectedItem.ToString() != "NONE CAN")) comboBox5.SelectedItem = "NONE CAN";
            ...
            if(SelectModel != IOPort.GetModel)
            {
                ...
                if(comboBox1.SelectedItem != null)
                {
                    if (SelectModel == __MODEL.MODEL_11P)
                    {
                        if (comboBox1.SelectedItem.ToString() != "KA4 11P") 
                        { 
                            comboBox1.SelectedItem = "KA4 11P"; 
                            Flag = false; 
                        }
                    }
                    else if (SelectModel == __MODEL.MODEL_9P)
                    {
                        if (comboBox1.SelectedItem.ToString() != "KA4 9P")
                        {
                            comboBox1.SelectedItem = "KA4 9P";
                            Flag = false;
                        }
                    }
                    else if (SelectModel == __MODEL.MODEL_78P)
                    ...
                    {
                        if (comboBox1.SelectedItem.ToString() != "KA4 RELAX")
                        {
                            comboBox1.SelectedItem = "KA4 RELAX";
                            Flag = false;
                        }
                    }
                }
...
//#endif
                    ...
                    else
                    {
                        if (IOPort.Get1StDownSensor == true)
                        {
                            ...
                            { 
                                ...
                                if (5000 <= (SbrTestTimeToLast - SbrTestTimeToFirst))
                                {
                    ...
                    if (GetCurrCheck(xStep) == true)
                    {
                        ...
                        if (CheckItem.Vent.Curr == true)
                        {
                            if (8000 <= (pLast - pFirst))
                            {
                                ...
                                {
                                    fpSpread1.ActiveSheet.Cells[4, 6].Text = string.Format("{0:0.0}", TData.VentCurr.Data);
        ...
        private void CheckRetractor()
        {
            ...
            else
            {
                ...
                if (500 <= (pLast - pFirst))
                {
                    float Value = (float)MultiMeter.GetReadData + TSpec.Offset.Retractor;
            ...
            else
            {
                ...
                if (Flag == true)
                {
                    ...
                    if ((TSpec.SWCheckTime * 1000) <= (pLast - pFirst))
                    {
                        ...
                        fpSpread1.ActiveSheet.Cells[8 + xStep, 6].Text = string.Format("{0:0.0}", Value);
                        fpSpread1.ActiveSheet.Cells[8 + xStep, 7].Text = "NG";
                        fpSpread1.ActiveSheet.Cells[8 + xStep, 7].BackColor = Color.Black;
                        fpSpread1.ActiveSheet.Cells[8 + xStep, 7].ForeColor = Color.Red;
                        Step += 4;
        ...
        private void CreateFileName()
        {
            ...
            if (File.Exists(TInfor.DataName) == false)
            {
                CreateDataFile();
            }
            else
            {
                fpSpread2.OpenExcel(TInfor.DataName);
        ...
        private void SaveData()
        {
            ...
            if (File.Exists(TInfor.DataName) == false) CreateDataFile();
            ...
            */
            ...
            if (TData.PW_Recline.Test == true)
            {
                fpSpread2.ActiveSheet.Cells[RowCount, Col].BackColor = Color.White;
                fpSpread2.ActiveSheet.Cells[RowCount, Col].ForeColor = Color.Black;
                fpSpread2.ActiveSheet.Cells[RowCount, Col].Text = fpSpread1.ActiveSheet.Cells[9, 3].Text;
                Col++;
            ...
            fpSpread2.SaveExcel(TInfor.DataName);
            return;
        }
        ...
        private void OpenInfor()
        {
            ...
            if (Ini.ReadString("NAME", "DATA", ref TInfor.DataName) == false) TInfor.DataName = "";
        ...
        private void DisplayAdData4()
        {
            if (MultiMeter != null)
            {
                if (MultiMeter.GetReadData < 9999)
                {
                    if (label27.Visible == true) label27.Visible = false;
                    if (sevenSegmentAnalog4.Value.AsDouble != MultiMeter.GetReadData) sevenSegmentAnalog4.Value.AsDouble = MultiMeter.GetReadData;
                }
                else
                {
        ...
        public MultiMeterControl GetMultiMeter
        {
