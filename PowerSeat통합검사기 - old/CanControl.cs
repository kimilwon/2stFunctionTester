...
namespace PowerSeat통합검사기
{
    public class __CanControl
    {
        ...
        public bool OpenCan(short Channel, int ID, short Speed,bool m_IsFD)
        {
#if PROGRAM_RUNNING
            TPCANStatus stsResult;
            UInt32 iBuffer;
            ...
            try
            {
                try
                {
                    ...
                    //switch (ID)
                    //{
                    //    case 0: m_PcanHandle[Channel] = (byte)PCANBasic.PCAN_USBBUS1; break;
                    //    case 1: m_PcanHandle[Channel] = (byte)PCANBasic.PCAN_USBBUS2; break;
                    //    case 2: m_PcanHandle[Channel] = (byte)PCANBasic.PCAN_USBBUS3; break;
                    //    case 3: m_PcanHandle[Channel] = (byte)PCANBasic.PCAN_USBBUS4; break;
                    //    case 4: m_PcanHandle[Channel] = (byte)PCANBasic.PCAN_USBBUS5; break;
                    //    case 5: m_PcanHandle[Channel] = (byte)PCANBasic.PCAN_USBBUS6; break;
                    //    case 6: m_PcanHandle[Channel] = (byte)PCANBasic.PCAN_USBBUS7; break;
                    //    case 7: m_PcanHandle[Channel] = (byte)PCANBasic.PCAN_USBBUS8; break;
                    //    default: m_PcanHandle[Channel] = (byte)PCANBasic.PCAN_USBBUS1; break;
                    //}

                    //m_PcanHandle[Channel] = ID;
                    ...
                    if (m_IsFD)
                    {
                        ...
                        if (Speed == 11)
                            s = "f_clock=20000000, nom_brp=5, nom_tseg1=5, nom_tseg2=2, nom_sjw=1, data_brp=2, data_tseg1=3, data_tseg2=1, data_sjw=1";
                        else if (Speed == 13)
                            s = "f_clock_mhz = 20,nom_brp = 5,nom_tseg1 = 2,nom_tseg2 = 1,nom_sjw = 1,data_brp = 2,data_tseg1 = 3, data_tseg2 = 1,data_sjw = 1";
                        else s = "f_clock=20000000, nom_brp=5, nom_tseg1=12, nom_tseg2=3, nom_sjw=1, data_brp=2, data_tseg1=3, data_tseg2=1, data_sjw=1"; // 250K
