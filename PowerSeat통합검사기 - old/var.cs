...
namespace PowerSeat통합검사기
{
    ...
    public class IO_IN
    {
        ...
        public const short MANUAL_SBR_1ST_UP = SERIAL + 20;
        public const short MANUAL_SBR_1ST_DOWN = SERIAL + 21;
        public const short MANUAL_SBR_2ST_UP = SERIAL + 22;
        public const short MANUAL_SBR_2ST_DOWN = SERIAL + 23;        
        public const short HEATER_LAMP_2WIRE = 15;
    };
